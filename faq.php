...
<?php include('includes/nav.php'); ?>
		...
		<div class="ts container" name="main">
			...
			<p>對於準交大生，靠北交大團隊特別提供帳號申請服務，不管您是百川、資工、電機特殊選才，還是碩班、博班正取生，只要將相關證明寄至維護團隊，即可幫您配發一個臨時帳號，正常使用此服務。</p>
			...
			<p>其中 140.113.136.218 - 140.113.136.220 是<b>校內無線網路</b>的 IP 位址、140.113.0.229 是<b>交大 VPN</b> 的 IP 位址，一個人可以拿到多個 IP 位址、也會有非常多人拿到同一個位址。公開出來無法識別出個人，讓審核者們知道投稿者<b>不一定是交大師生</b>，並將套用 (C) 台灣 IP 位址規則。</p>
